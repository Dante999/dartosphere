...
static void test_remaining_points_when_checkout_master(void)
{
	struct Checkout_Testcases cases[] = {
		{
			.testname = "GIVEN_checkout_master_WHEN_one_point_left_WITH_single_throw_THEN_player_overshoot",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 10,
			.current_throw   = dart_hit_make(DARTS_SINGLE, 9),
			.expected_result = X01_RESULT_PLAYER_OVERSHOOT
		...
		{
			.testname = "GIVEN_checkout_master_WHEN_one_point_left_WITH_double_throw_THEN_player_overshoot",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 9,
			.current_throw   = dart_hit_make(DARTS_DOUBLE, 4),
			.expected_result = X01_RESULT_PLAYER_OVERSHOOT
		...
		{
			.testname = "GIVEN_checkout_master_WHEN_one_point_left_WITH_tripple_throw_THEN_player_overshoot",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 10,
			.current_throw   = dart_hit_make(DARTS_TRIPPLE, 3),
			.expected_result = X01_RESULT_PLAYER_OVERSHOOT
		...
		{
			.testname = "GIVEN_checkout_master_WHEN_two_points_left_WITH_single_throw_THEN_player_can_continue",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 10,
			.current_throw   = dart_hit_make(DARTS_SINGLE, 8),
			.expected_result = X01_RESULT_CONTINUE
		...
		{
			.testname = "GIVEN_checkout_master_WHEN_two_points_left_WITH_double_throw_THEN_player_can_continue",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 10,
			.current_throw   = dart_hit_make(DARTS_DOUBLE, 4),
			.expected_result = X01_RESULT_CONTINUE
		...
		{
			.testname = "GIVEN_checkout_master_WHEN_two_points_left_WITH_tripple_throw_THEN_player_can_continue",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 11,
			.current_throw   = dart_hit_make(DARTS_TRIPPLE, 3),
			.expected_result = X01_RESULT_CONTINUE
		...
		{
			.testname = "GIVEN_checkout_master_WHEN_three_points_left_WITH_single_throw_THEN_player_can_continue",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 10,
			.current_throw   = dart_hit_make(DARTS_SINGLE, 7),
			.expected_result = X01_RESULT_CONTINUE
		...
		{
			.testname = "GIVEN_checkout_master_WHEN_three_points_left_WITH_double_throw_THEN_player_can_continue",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 11,
			.current_throw   = dart_hit_make(DARTS_DOUBLE, 4),
			.expected_result = X01_RESULT_CONTINUE
		...
		{
			.testname = "GIVEN_checkout_master_WHEN_three_points_left_WITH_tripple_throw_THEN_player_can_continue",
			.checkout_mode   = X01_MODE_MASTER,
			.player_score    = 12,
			.current_throw   = dart_hit_make(DARTS_TRIPPLE, 3),
			.expected_result = X01_RESULT_CONTINUE
...
void main_test_game_x01(void)
{
	...
	RUNTEST(test_remaining_points_when_checkout_master);
}
